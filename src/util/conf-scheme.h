...
static inline void ffconf_scheme_init(ffconf_scheme *cs, _fcom_conf *parser)
{
	ffmem_zero_obj(cs);
	cs->parser = parser;
}
...
{
	ffconf_scheme_addctx(cs, (struct ffconf_arg*)-1, (struct ffconf_arg*)-1);
}
